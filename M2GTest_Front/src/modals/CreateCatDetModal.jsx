...
import { createCatalogDetail, getEditData } from "../utils/apiCalls";

function CreateCatDetModal({
  openModal,
  setOpenModal,
  setData,
  setDone,
  ...
  async function HandleSubmit() {
    await createCatalogDetail(parentId, id, estado, detalle);
    setOpenModal(false);
      ...
      <Modal open={openModal}>
        ...
        <div className="mb-3 w-full flex flex-col justify-end items-center text-gray-900">
          <button
            ...
            disabled={id && detalle && estado ? false : true}
...
export default CreateCatDetModal;
